...
const { postProperty, showProperties, showProperty,findProperty, deleteProperty, updateProperty, listRelated , listBySearch, updateAvailability} = require('../controller/propertyController')
...
router.put('/updateAvailability/:id',requireSignin,updateAvailability)
