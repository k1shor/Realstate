...
const { postConsultations, consultationsList, consultationDetails,  deleteconsultations, userconsultations, updateStatus } = require('../controller/consultationController')
