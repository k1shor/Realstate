exports.propertyValidation=(req,res,next)=>{
    ...
    req.check('added_by','Please accept the terms and conditions').notEmpty()
    req.check('listing_type','Please choose listing type').notEmpty()
...
exports.messageValidation=(req,res,next)=>{
    req.check('email', 'Email is required').notEmpty()
